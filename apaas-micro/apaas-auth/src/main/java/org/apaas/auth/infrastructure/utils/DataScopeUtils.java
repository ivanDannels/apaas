 ...
 */
package org.apaas.auth.infrastructure.utils;

import org.apaas.auth.domain.vo.DataScope;
...
public class DataScopeUtils {
    ...
    public static String buildDataScopeSql(DataScope dataScope, List<Long> organizationIds, Long userId, Long tenantId, String organizationColumn, String userIdColumn, String tenantIdColumn) {
        ...
        // 租户过滤（除了ALL_TENANTS）
        if (dataScope != org.apaas.auth.domain.vo.DataScope.ALL_TENANTS && tenantId != null && tenantId > 0) {
        ...
        // 用户过滤（仅CURRENT_USER）
        if (dataScope == org.apaas.auth.domain.vo.DataScope.CURRENT_USER && userId != null && userId > 0) {
