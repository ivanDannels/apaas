 ...
 */
package org.apaas.flow.engine.interfaces.rest;
...
public class ReactiveFlowInstanceController extends ReactiveBaseController<FlowInstanceDTO, Long, ReactiveFlowInstanceService> {
    ...
    public Mono<FlowInstanceDTO> startInstance(@RequestBody StartInstanceDTO startInstanceDTO) {
    ...
    public Mono<FlowInstanceDTO> terminateInstance(@Parameter(description = "实例ID", required = true) @PathVariable Long id) {
    ...
    public Mono<FlowInstanceDTO> suspendInstance(@Parameter(description = "实例ID", required = true) @PathVariable Long id) {
    ...
    public Mono<FlowInstanceDTO> resumeInstance(@Parameter(description = "实例ID", required = true) @PathVariable Long id) {
    ...
    public Flux<FlowInstanceDTO> getInstanceTasks(@Parameter(description = "实例ID", required = true) @PathVariable Long id) {
