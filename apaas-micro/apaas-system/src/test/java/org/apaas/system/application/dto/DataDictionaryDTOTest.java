...
class DataDictionaryDTOTest {
    ...
    void testToString() {
        ...
        assertTrue(toStringResult.contains("DataDictionaryDTO"));
        assertTrue(toStringResult.contains("id=1"));
        assertTrue(toStringResult.contains("name=用户状态"));
        assertTrue(toStringResult.contains("code=user_status"));
    }
}