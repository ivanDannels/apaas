 ...
 * @author ivan
 */
public interface DataDictionaryApplicationService extends ApplicationService<DataDictionaryAggregate, Long> {
     ...
     * 创建数据字典
     */
    Mono<Boolean> create(DataDictionaryDTO dictionaryDto);
    
    /**
     * 更新数据字典
     */
    Mono<Boolean> update(DataDictionaryDTO dictionaryDto);
