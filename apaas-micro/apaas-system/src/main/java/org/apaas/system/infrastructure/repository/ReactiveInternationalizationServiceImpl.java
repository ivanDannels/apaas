...
public class ReactiveInternationalizationServiceImpl extends AbstractApplicationService<Internationalization, Long, InternationalizationRepository> implements ReactiveInternationalizationService {
    ...
    private final InternationalizationRepository repository;
    ...
    @Override
    public Flux<Internationalization> getMessagesByLanguage(String language) {
        // 根据语言查询所有国际化消息
        return repository.findAll()
            .filter(msg -> msg.getLanguage() != null && msg.getLanguage().equals(language));
    }
}