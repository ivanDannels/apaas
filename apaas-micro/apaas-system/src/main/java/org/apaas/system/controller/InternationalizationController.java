...
import org.apaas.system.service.InternationalizationService;
...
public class InternationalizationController {
     ...
     * @return 结果
     */
    @GetMapping(value = "/changeLanguage", produces = MediaType.TEXT_PLAIN_VALUE)
     ...
     * @return 当前语言代码
     */
    @GetMapping(value = "/currentLanguage", produces = MediaType.TEXT_PLAIN_VALUE)
    @Operation(summary = "获取当前语言", description = "获取当前系统语言")
    public Mono<String> getCurrentLanguage() {
        return Mono.just(i18nService.getCurrentLanguage());
    }
    ...
    public Mono<String> getMessage(@RequestParam String code) {
        return Mono.just(i18nService.getMessage(code));
    }
    ...
    public Mono<Map<String, String>> getMessages(@RequestBody String[] codes) {
        ...
        for (String code : codes) {
            messages.put(code, i18nService.getMessage(code));
        }
