...
public interface SysConfigAssembler {
     ...
     * 将系统配置DTO转换为系统配置实体
     */
    SysConfig convertDtoToEntity(SysConfigDTO sysConfigDTO);
    
    /**
     * 将系统配置实体转换为系统配置DTO
     */
    SysConfigDTO convertEntityToDto(SysConfig sysConfig);
    
    /**
     * 将系统配置实体列表转换为系统配置DTO列表
     */
    List<SysConfigDTO> convertEntityListToDtoList(List<SysConfig> sysConfigList);
}