...
public class DataDictionaryItemRest extends BaseRest<DataDictionaryItem, Long, ReactiveDataDictionaryItemService> {
    
    public DataDictionaryItemRest(ReactiveDataDictionaryItemService service) {
        super(service);
    }
