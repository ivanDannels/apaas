...
import org.apaas.system.application.assembler.DataDictionaryAssembler;
...
public class DataDictionaryApplicationServiceImpl extends AbstractApplicationService<DataDictionaryAggregate, Long, DataDictionaryAggregateRepository> implements DataDictionaryApplicationService {
    ...
    @Override
    public Mono<Boolean> create(DataDictionaryDTO dictionaryDto) {
        DataDictionaryAggregate dictionary = DataDictionaryAssembler.INSTANCE.convertDtoToAggregate(dictionaryDto);
    ...
    @Override
    @CacheEvict(value = "dataDictionaries", key = "#dictionaryDto.id")
    public Mono<Boolean> update(DataDictionaryDTO dictionaryDto) {
        DataDictionaryAggregate dictionary = DataDictionaryAssembler.INSTANCE.convertDtoToAggregate(dictionaryDto);
