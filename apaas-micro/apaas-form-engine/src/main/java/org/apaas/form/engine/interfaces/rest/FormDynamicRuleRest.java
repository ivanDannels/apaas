...
public class FormDynamicRuleRest extends BaseRest<FormDynamicRule, Long, ReactiveFormDynamicRuleService> {
    
    public FormDynamicRuleRest(ReactiveFormDynamicRuleService service) {
        super(service);
    }
    ...
    @Operation(summary = "分页查询表单动态规则列表", description = "分页查询表单动态规则列表")
    ...
    public Flux<FormDynamicRule> selectPage(@RequestParam Long formId, @RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
        return service.selectPage(formId, page, size).flux();
    }
    ...
    @Operation(summary = "根据表单ID查询动态规则列表", description = "根据表单ID查询动态规则列表")
