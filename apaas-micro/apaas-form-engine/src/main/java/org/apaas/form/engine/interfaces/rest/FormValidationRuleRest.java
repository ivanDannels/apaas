...
public class FormValidationRuleRest extends BaseRest<FormValidationRule, Long, ReactiveFormValidationRuleService> {
    
    public FormValidationRuleRest(ReactiveFormValidationRuleService service) {
        super(service);
    }
    ...
    public Mono<org.apaas.core.query.PageResult<FormValidationRule>> selectPage(@RequestParam Long fieldId, @RequestParam Integer pageNum, @RequestParam Integer pageSize) {
