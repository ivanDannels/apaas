...
public class ReactiveFormInstanceServiceImpl extends BaseServiceImpl<FormInstance, Long, FormInstanceRepository> implements ReactiveFormInstanceService {
    ...
    public ReactiveFormInstanceServiceImpl(FormInstanceRepository repository, RedisDomainEventPublisher<org.apaas.core.event.EntityChangedEvent<FormInstance>> eventPublisher) {
