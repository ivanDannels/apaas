...
import org.apaas.domain.entity.Money;
import org.apaas.domain.entity.Order;
import org.apaas.domain.entity.OrderItem;
...
public class OrderFactory implements EntityFactory<Order, Long> {
    ...
    public Order createFrom(Order prototype) {
        Order order = Order.builder()
                .id(prototype.getId())
                .customerId(prototype.getCustomerId())
                .orderNo(prototype.getOrderNo())
                .status(prototype.getStatus())
                .totalAmount(prototype.getTotalAmount())
                .orderTime(prototype.getOrderTime())
                .build();
