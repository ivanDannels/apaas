...
public class OrderApplicationService extends AbstractApplicationService<Order, Long, OrderRepository> {
    ...
    private final org.apaas.domain.domain.service.OrderDomainService orderDomainService;
    
    public OrderApplicationService(OrderRepository repository, org.apaas.domain.domain.service.OrderDomainService orderDomainService) {
        super(repository);
