 ...
 * @param <R> 仓库类型
 */
public abstract class AbstractDomainService<T extends BaseEntity<ID>, ID extends Serializable, R extends ReactiveBaseRepository<T, ID>> implements DomainService<T> {
