 ...
 */
package org.apaas.domain.interfaces.rest;
...
public abstract class ReactiveBaseController<T extends BaseEntity<ID>, ID extends Serializable, S extends ApplicationService<T, ID>> {
